          ...
          <FadeUpGroup className="grid md:grid-cols-2 lg:grid-cols-3 gap-6" stagger={0.07}>
            {testimonials.map((t) => (
              <FadeUpItem key={t.author}>
                <div className="bg-obsidian-2 border border-gold/15 p-8 hover:border-gold/35 transition-colors h-full flex flex-col">
                  {/* Opening quote mark */}
                  <div className="font-display text-5xl text-gold/15 leading-none mb-4">&quot;</div>

                  {/* Quote */}
                  <p className="font-display text-base italic text-cream-2 leading-relaxed flex-1 mb-4">
                    {t.quote}
                  </p>
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-gold/15">
                    <div className="w-10 h-10 rounded-full border border-gold/35 bg-obsidian-4 flex items-center justify-center font-display text-gold text-sm shrink-0">
                      {t.initials}
                    </div>
                    <div>
      ...
      <section className="py-24 px-6 bg-obsidian-2">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <FadeUpGroup className="flex flex-wrap justify-center gap-3" stagger={0.05}>
            {industries.map((ind) => (
              <FadeUpItem key={ind}>
                <span className="border border-gold/15 bg-obsidian px-6 py-3 text-muted-oq text-sm tracking-wide hover:border-gold/35 hover:text-cream transition-all cursor-default block">
                  {ind}
                </span>
              </FadeUpItem>
            ))}
