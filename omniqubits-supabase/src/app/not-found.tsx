export default function NotFound() {
  return (
    <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "#080A0E", fontFamily: "'Jost', sans-serif", textAlign: "center", padding: "2rem" }}>
      ...
      <a href="/" style={{ border: "1px solid rgba(201,169,110,0.4)", color: "#C9A96E", padding: "0.75rem 2.5rem", fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", textDecoration: "none" }}>Return Home</a>
    </main>
  );
}
